...
const SalonRoute = () => {
  ...
  return (
    <Switch>
      ...
      <Route exact path={`${path}/salon/review/edit/:id`} component={SalonReviewEdit} />
      ...
      <Route exact path={`${path}/salon/availibility-hours/edit/:id`} component={SalonAvailEdit} />

      <Route path={`${path}/salon/address-view`} component={SalonAddressView} />
      <Route path={`${path}/salon/address-add`} component={SalonAddressAdd} />
      <Route exact path={`${path}/salon/address/edit/:id`} component={SalonAddressEdit} />
    </Switch>
  );
};
